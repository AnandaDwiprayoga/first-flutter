...
class MainScreen extends StatelessWidget {
  final tourismPlaceList = [
    ...
    TourismPlace(
      ...
      imgTag: 'Observatorium Bosscha img',
    ),
    TourismPlace(
    ...
    TourismPlace(
      ...
      imgTag: 'Taman Film Pasopati img',
    ),
    TourismPlace(
      name: 'Museum Geologi',
      location: 'Kota Bandung',
